...
print('Guido van Rossumm once said, "Python is an experiment in how much freedom programmers need. Too much freedom and nobody can read another\'s code; too little and expressivness is endangered"')
...
print("Python was releasedd in", 1991)
